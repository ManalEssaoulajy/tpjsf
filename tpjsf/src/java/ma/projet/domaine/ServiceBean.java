...
public Service getSelectedService() {
 ...
 public List<Employee> getEmployees() {
        // Assurez-vous de retourner la liste correcte d'employés pour selectedService
        if (selectedService != null) {
            return selectedService.getEmployeees();
        } else {
            return Collections.emptyList(); // ou null selon votre logique
        }
    }
    ...
    public ChartModel initBarModel() {
        ...
        for (Service s : serviceService.getAll()) {
            services.set(s.getNom(), s.getEmployeees().size());
        }
